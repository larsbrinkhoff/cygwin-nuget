...
die "Perl lib version (5.14.4) doesn't match executable '$0' version ($])"
    unless $^V;

$^V eq 5.14.4
    or die "Perl lib version (5.14.4) doesn't match executable '$0' version (" .
	sprintf("v%vd",$^V) . ")";
...
tie %Config, 'Config', {
    archlibexp => '/usr/lib/perl5/5.14/x86_64-cygwin-threads',
